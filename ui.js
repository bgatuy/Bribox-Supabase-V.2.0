    ...
    const handleLogout = async (e) => {
        ...
        if (confirmed) {
            try {
                ...
                // Jika signOut gagal karena sesi sudah tidak valid (mis. logout dari device lain),
                // error akan dilempar dan kita tangkap di bawah.
                if (error) throw error;
            } catch (error) {
                // Error ini wajar terjadi jika sesi sudah tidak valid.
                // Kita tangkap agar tidak muncul sebagai "uncaught error" di console.
                // Library Supabase akan tetap membersihkan sesi lokal, dan onAuthStateChange
                // di supabase-client.js akan menangani redirect.
