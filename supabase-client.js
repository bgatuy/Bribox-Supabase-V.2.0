      ...
      if (!window.__idleTimeoutSetup) {
        ...
        const resetIdleTimer = () => {
          ...
          idleTimer = setTimeout(async () => {
            // Cukup panggil signOut(). Listener onAuthStateChange di bawah akan
            // menangani redirect secara otomatis saat mendeteksi event 'SIGNED_OUT'.
            // Ini mencegah duplikasi logika dan lebih andal.
